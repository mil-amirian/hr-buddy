    ...
    <>
      ...
      <div className="container align-items-center">
        <div className="row d-flex justify-content-center">
          <div className="menu-item col-md-5 border border-light m-2" onClick={() => { props.setView('view-employees'); }}>
            <i className="menu-icon fas fa-address-card fa-7x"/>
            <h2>View Employees</h2>
          </div>
          <div className="menu-item col-md-5 border border-light m-2" onClick={() => { props.setView('view-departments'); }}>
            <i className="menu-icon fas fa-users fa-7x"/>
            <h2>View Departments</h2>
          </div>
        </div>
        <div className="row d-flex justify-content-center">
          <div className="menu-item col-md-5 border border-light m-2" onClick={() => { props.setView('add-employee'); }}>
