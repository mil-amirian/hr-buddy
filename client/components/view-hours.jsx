        ...
        <div className="hours-container d-flex flex-column justify-content-around mt-5">
          <div>
            ...
            <span className="department-qty">
              ...
              {this.state.selectedDepartment.totalHours} Hrs.</span>
          </div>
          <div>
        ...
        <div className="hours-container d-flex flex-column justify-content-around mt-5">
          <div>
            ...
            <span className="department-qty">
              ...
              {this.state.selectedEmployee.totalHours} Hrs.</span>
          </div>
          <div>
            ...
            <div className="title d-flex justify-content-around hours-title align-middle">
              <div>
                ...
                <span className="department-qty">
                  ...
                  {this.state.allHours.totalHours} Hrs for all employees</span>
              </div>
              <div>
